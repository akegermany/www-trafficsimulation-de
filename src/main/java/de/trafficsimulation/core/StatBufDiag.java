...
public class StatBufDiag extends Component {
    ...
    public StatBufDiag(double xmin, double xmax, double ymin, double ymax, int nptsx, int nptsy, int bufferlength,
            Color bg, Color fg, Image image, String xlabel, String ylabel, String label, String title, double xtic,
