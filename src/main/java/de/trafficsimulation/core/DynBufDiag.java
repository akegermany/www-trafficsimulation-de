...
public class DynBufDiag extends Component {
    ...
    public DynBufDiag(double xmin, double xmax, double ymin, double ymax, int nptsx, int nptsy, double maxdiff,
            Color bg, Color fg, Image image, String xlabel, String[] ylabels, Color[] colors, String label,
            String title, double xtic, String xticLabel, double[] ytics, String yticLabels[]) {
        if (xmin > 0.0) {
            xmin = 0.0;
        }
        if (ymin > 0.0) {
