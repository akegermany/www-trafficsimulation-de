...
public abstract class IDM implements MicroModel {
    ...
    public void initialize() {
        ...
        System.out.println("IDM.initialize():" + "  veqTab[0]=" + veqTab[0] + ", veqTab[" + ismax + "]="
                + veqTab[ismax]);
    ...
    public double calcAcc(Moveable bwd, Moveable vwd) {
        ...
        double s_star_raw = s0 + s1 * Math.sqrt(vel / v0) + vel * T + (vel * delta_v) / (2 * sqrtab);
