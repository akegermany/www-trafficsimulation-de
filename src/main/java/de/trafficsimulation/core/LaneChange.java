...
public class LaneChange implements Constants {
    ...
    public LaneChange(double p, double db, double gapMin, double bsave, double biasRight) {
        this(p, db);
    ...
    public boolean changeOK(Moveable me, Moveable fOld, Moveable fNew, Moveable bNew) {
        ...
        double my_adv = my_acc - me.model().calcAcc(me, fOld) + ((me.lane() == LEFT) ? 1 : -1) * biasRight;
